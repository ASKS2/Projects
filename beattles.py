...
# Some people consider them to be the most influential act of the rock era. Indeed, they were included in Time magazine's
...
for _ in range(2):
	beatles.append(input("Enter the name of the member (only one at a time): "))
